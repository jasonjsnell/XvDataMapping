...
//feed in signalProcessedStreams.peaks from XvSignalProcessor
...
public class XvNegativePeakDetector:XvPeakDetector {
...
public class XvPositivePeakDetector:XvPeakDetector {
